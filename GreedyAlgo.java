...
public class GreedyAlgo {
        ...
        for (int i = n - 1; i >= 0; i--) {
            ...
            if (k > 0) {
                ...
                if (k >= 26) {// assign z in the n-1 index !
                    ...
                    ch[i] = (char) (k + 97 - 1); // converting the remaining k val into char and assigning the char into
                                                 // last index
    ...
    public static void main(String[] args) {
        ...
        for (int row[] : dp)
            Arrays.fill(row, -1); // Fill with -1 (not computed yet){
        ...
        // System.out.println( "the knapsack value will be : " + knapsackTab(val,
        // weight, W));
    }
    ...
    public boolean lemonadeChange(int[] bills) {
        ...
        for (int bill : bills) {
            ...
            // 10 case
                ...
                // doesnot have sufficient change
                else {
                    return false;
                }
            }
